...
@Component({
  selector: 'app-cours-details-directeur',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './cours-details-directeur.component.html',
  styleUrl: './cours-details-directeur.component.scss'
})
export class CoursDetailsDirecteurComponent {
